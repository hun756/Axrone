...
import type { GltfComponentSnapshot, CameraComponentData } from './gltf-component-snapshot';
...
export const createCameraSnapshot = (
    ...
    return Object.freeze({
        ...
        data: Object.freeze({
            ...
            ...(camera.perspective.zfar !== undefined ? { far: camera.perspective.zfar } : {}),
