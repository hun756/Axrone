...
export type BoundingSphereCenter = Readonly<BoundingSphere>['center'];

export const isBoundingSphereCenterTuple = (center: BoundingSphereCenter): center is readonly [number, number, number] =>
